...
do
    ...
    function new_mfile()
        ...
        repeat cnt=cnt+1; fn="m/C2-"..cnt..".txt"
    ...
    function m_start()
        ...
        uart_on("data","\n",function(data)
            ...
            if (cmds[cmdi]=="VER\r\n" or data=="OK") then
                ...
                if cmdi > #cmds then
                    ...
                    -- set led
                    setmled(M_SUCCESS)
                    print("C2 measurement finished. file: "..fn);
                    return
                end
                f:write(">"..cmds[cmdi])
        ...
        comTO:alarm(500,tmr.ALARM_SINGLE,function(timer)
            ...
            f:close()
            f=nil
            print("C2 response timeout during measurement");
            comTO=nil
            -- set led
            setmled(M_ERROR)
